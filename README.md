...
* `/find [floor] [message]`: Send a message telling club members to dig to a specific floor
* `/kill [floor] [message]`: Send a message telling club members to kill a specific floor boss (which roles get pinged is defined per floor in `commands/war-commands.js`)
